...
# {{< icon "fab fa-amazon" >}} Amazon S3

This is a backend for the Amazon Simple Storage Service (Amazon S3) service
provided by Amazon Web Services (AWS), as well as many of the other providers
using a compatible Amazon S3 API.
